...
import { MasterRateType } from "src/entities/master/master_rate_type.entity"; // Adjust path as necessary
import { MasterRoomType } from "src/entities/master/master_room_types.entity"; // Adjust path as necessary
