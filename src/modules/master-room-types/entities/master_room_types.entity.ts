...
import { MasterRoomTypeRate } from "src/modules/master-rate-types/entities/master_room_type_rates.entity";
import { SeasonRoomTypeMapping } from "src/modules/master-seasons/entities/master_season_room_type_mapping.entity";
...
export class MasterRoomType extends CoreEntity {
    ...
    @OneToMany(
        () => MasterRoomTypeRate,
        (roomTypeRate) => roomTypeRate.roomType
    )
