...
import { MasterPermissionModules } from "src/modules/master-roles/entities/master_permission_module.entity";
...
export class UserPermission extends CoreEntity {
    ...
    @ManyToOne(
        ...
        (module) => module.userPermissions
    ) // Assuming 'userPermissions' on your module entity
