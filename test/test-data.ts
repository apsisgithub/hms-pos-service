import { BuildingStatus } from 'src/modules/master-buildings/entities/master_building.entity';
import { BusinessSourceStatus } from 'src/modules/master-business-sources/entities/master_business_sources.entity';
...
export const TestData = {
  ...
  buildings: {
    ...
    validSecond: {
      ...
      description: 'Secondary building with ocean-facing rooms and conference facilities',
      status: BuildingStatus.Active,
    },
    invalid: {
