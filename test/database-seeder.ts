...
import {
    MasterSbu,
    MasterSbuStatus,
} from "../src/modules/master-sbu/entities/master_sbu.entity";
import {
    MasterBuilding,
    BuildingStatus,
} from "../src/modules/master-buildings/entities/master_building.entity";
import {
    MasterRole,
    RoleName,
    RoleStatus,
...
} from "../src/modules/master-business-sources/entities/master_business_sources.entity";
import {
    MasterPaymentMode,
    PaymentModeStatus,
...
import {
    CurrencyStatus,
    MasterCurrency,
} from "../src/modules/master-currencies/entities/master_currencies.entity";
import {
    MasterDepartment,
    DepartmentStatus,
} from "../src/modules/master-departments/entities/master_departments.entity";
...
export class DatabaseSeeder {
    ...
    async initialize() {
        ...
        this.departmentRepository =
            this.dataSource.getRepository(MasterDepartment);
    }
    ...
    async seedTestData() {
        ...
        try {
            ...
            const existingPaymentMode =
                await this.paymentModeRepository.findOne({ where: { id: 1 } });
    ...
    async cleanupSpecificEntity<T extends object>(
        ...
        try {
            ...
            console.log(
                `✅ ${entityName} cleaned up (${result.affected} records)`
            );
        } catch (error) {
